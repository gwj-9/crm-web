  ...
  <div class="table-box">
    <ProTable ref="proTable" title="客户列表" rowKey="id" :columns="columns" :requestApi="CustomerApi.page" :data-callback="dataCallback" :init-param="initParam">
      ...
      <template #tableHeader="scope">
        ...
        <el-button type="danger" :icon="Delete" :disabled="!scope.isSelected" v-hasPermi="['sys:customer:remove']" @click="batchDelete(scope.selectedListIds)">
          批量删除
        </el-button>
...
<script setup lang="ts" name="Customeranage">
